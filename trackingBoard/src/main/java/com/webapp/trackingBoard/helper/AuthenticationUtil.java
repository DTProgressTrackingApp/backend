...
public class AuthenticationUtil implements Serializable {
	private static final String secret = "KanbanApp123456789abcdefghijklmnopqrstuvz1234567890";
	...
	public Boolean validateToken(String token, UserDetails userDetails) throws JsonProcessingException {
		String obj = getClaimFromToken(token, Claims::getSubject);
		User user = objectMapper.readValue(obj, User.class);
		log.info("Validate from token: " + objectMapper.writeValueAsString(user));
